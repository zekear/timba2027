    ...
    <main className="max-w-4xl mx-auto p-8">
      <header className="border-b-2 border-ink pb-4 mb-6">
        ...
        <div className="font-mono text-xs uppercase tracking-wide text-caption mt-2">
          {drafts.length} drafts shown · <a href="/admin/decisions" className="text-accent underline">decisiones</a> · <a href="/admin/engagement" className="text-accent underline">engagement</a> · <a href="/admin/settings" className="text-accent underline">settings</a>
        </div>
      </header>
